...
import com.sivert.schat2.utilits.AppVoicePlayer
...
class HolderVoiceMessage(view: View) : RecyclerView.ViewHolder(view), MessageHolder {
    ...
    private val blocReceiverVoiceMessage: ConstraintLayout = view.bloc_received_voice_message
    ...
    private val chatReceiverVoiceMessageTime: TextView = view.chat_received_voice_message_time
    ...
    override fun drawMessage(view: MessageView) {
        if (view.from == CURRENT_UID) {
            ...
            chatReceiverVoiceMessageTime.text = view.timeStamp.asTime()
        }
    }
