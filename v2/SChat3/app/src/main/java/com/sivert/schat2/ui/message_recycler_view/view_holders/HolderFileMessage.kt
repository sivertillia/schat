...
import com.sivert.schat2.database.getFileToFromStorage
import com.sivert.schat2.ui.message_recycler_view.views.MessageView
import com.sivert.schat2.utilits.WRITE_FILES
import com.sivert.schat2.utilits.asTime
import com.sivert.schat2.utilits.checkPermission
import com.sivert.schat2.utilits.showToast
...
//        File dir = ctx.getDir("my_sub_dir", Context.MODE_PRIVATE)
        ...
        try {
            if (checkPermission(WRITE_FILES)) {
                file.createNewFile()
                getFileToFromStorage(file, view.fileUrl) {
                    if (view.from == CURRENT_UID) {
